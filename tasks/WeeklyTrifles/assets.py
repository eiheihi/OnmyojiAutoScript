...
class WeeklyTriflesAssets: 
	...
	# 秘闻分享 
	I_WT_SE_SHARE = RuleImage(roi_front=(914,579,42,33), roi_back=(882,552,101,73), threshold=0.8, method="Template matching", file="./tasks/WeeklyTrifles/secret/secret_wt_se_share.png")
	# 微信 
	...
	# 勾玉 
	I_WT_SE_JADE = RuleImage(roi_front=(1125,533,35,39), roi_back=(1101,507,82,85), threshold=0.8, method="Template matching", file="./tasks/WeeklyTrifles/secret/secret_wt_se_jade.png")
	# 排行 
