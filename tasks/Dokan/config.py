...
class DokanConfig(BaseModel):
    # # 寮管理开启道馆
    dokan_enable: bool = Field(default=True, description='寮管理开启道馆')

    # 道馆系数,赏金/人数 根据喜好配置
    find_dokan_score: float = Field(default=3.5, description='dokan_score_help')
    ...
    random_delay: bool = Field(default=True, description='random_delay_help')
